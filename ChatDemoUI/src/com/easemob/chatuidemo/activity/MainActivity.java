...
public class MainActivity extends BaseActivity implements EMEventListener {
	...
	private CreateRateFragment createRateFragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		createRateFragment=new CreateRateFragment();
		findFragment=new FindFragment();
//		fragments = new Fragment[] { chatHistoryFragment, contactListFragment, settingFragment, createRateFragment};
		fragments = new Fragment[] { chatHistoryFragment, contactListFragment, findFragment, createRateFragment};
		// 添加显示第一个fragment
		getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, chatHistoryFragment)
				.add(R.id.fragment_container, contactListFragment).add(R.id.fragment_container,createRateFragment).hide(contactListFragment).hide(chatHistoryFragment).show(createRateFragment)
				.commit();
...
//		mTabs[2] = (Button) findViewById(R.id.btn_setting);
		...
		mTabs[3] = (Button) findViewById(R.id.btn_create_rate);
		// 把第一个tab设为选中状态
//		mTabs[0].setSelected(true);
		mTabs[3].setSelected(true);

		registerForContextMenu(mTabs[1]);//注册上下文菜单
	}
