...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	private static final int REQUEST_CODE_Start_Alarm = 6;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        group = EMGroupManager.getInstance().getGroup(groupId);  //获得类EMGroup------group 
        ...
        mRladmin=(RelativeLayout) findViewById(R.id.rl_start_alarm);
	...
	public void onClick(View v) {
		...
		case R.id.rl_start_alarm:    //设置管理员
//			startActivity(new Intent(this,GroupPickAdminActivity.class));
			Intent alarmas = new Intent(AlarmClock.ACTION_SET_ALARM);
			startActivity(alarmas);
//			RelativeLayout mRlStartAlarm=(RelativeLayout) findViewById(R.id.rl_start_alarm);
//			ImageView mIvStartAlarm=(ImageView) mRlStartAlarm.findViewById(R.id.iv_start_alarm);
//			ImageView mIvCloseAlarm=(ImageView) mRlStartAlarm.findViewById(R.id.iv_close_alarm);
//			mIvStartAlarm.setVisibility(View.VISIBLE);
//			mIvCloseAlarm.setVisibility(View.INVISIBLE);
